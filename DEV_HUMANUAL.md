...
- 💡 I experiment first, document after (don’t worry, I comment well, I guess).
...
Distro: Fedora 43 (Wayland)
Editor: VSCode + Neovim + Zed hybrid
Shell: Zsh
Theme: Low-contrast dark, Ayu, Catppuccin (MD3 inspired)
Languages: Python, C++, TypeScript, Bash, Go
